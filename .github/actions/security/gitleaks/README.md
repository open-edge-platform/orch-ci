...
This action enables automated secret detection as part of a secure SDLC.

---

## Architecture and Execution Flow

The action executes in structured stages.
...
The action does not hard-fail automatically unless configured to do so.
...
These outputs allow downstream workflow logic to evaluate results.
...
Use baseline file to suppress known leaks:
...
The action uploads results using:
...
- Regularly refresh baseline files.
- Monitor artifact retention policies.
- Combine with SAST and dependency scanning for full coverage.
